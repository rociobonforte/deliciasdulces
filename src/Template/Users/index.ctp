    ...
    <div class="col-md-12">
        ...
        <div class="table-responsive">
            ...
            <thead>
                ...
                <th><?= $this->Paginator->sort('email', ['Correo electonico']) ?></th>
                <th>Acciones</th>
                </tr>
            </thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?= $this->Form->postLink('Eliminar', ['action' => 'delete', $user->id], ['confirm' => 'Elimina usuario ?', 'class' => 'btn btn-sm btn-danger']) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
                </tbody>
